...
import { RiLogoutBoxRLine } from "react-icons/ri"; // Importamos el ícono para cerrar sesión
import { logout, login } from "../store/actions/authActions"; // Acción de logout
import logo from "../images/LogoMyTinerary.png";
import "../styles/header.css";

function Header() {
    const authStore = useSelector(state => state.authStore); // Obtener el estado de autenticación desde Redux
...
//     const authStore = useSelector(state => state.authStore); // Obtener el estado de autenticación desde Redux
//     const token = useSelector((state) => state.authStore.token); // Obtener el token desde el estado
//     const photo = useSelector((state) => state.authStore.photo); // Obtener el token desde el estado
//     const navigate = useNavigate(); // Utilizamos el hook navigate
//     const dispatch = useDispatch();
...
//                     <div className="flex items-center space-x-3">
//                         <img
//                             src={photo || "/default-profile.jpg"} // Foto del usuario, con valor predeterminado
//                             alt="User Profile"
//                             className="w-10 h-10 rounded-full"
//                         />
//                         <span className="text-white">{authStore.user?.name}</span>
//                         <RiLogoutBoxRLine
//                             className="text-white text-4xl cursor-pointer"
//                             onClick={handleLogoutClick} // Redirige a home al hacer clic en logout y ejecuta el dispatch
//                         />
...
// import { FaUser } from "react-icons/fa";
// import { RiLogoutBoxRLine } from "react-icons/ri"; // Importamos el ícono para cerrar sesión
// import { logout } from "../store/actions/authActions"; // Acción de logout
// import logo from "../images/LogoMyTinerary.png";
// import "../styles/header.css";
...
//         if (!authStore.user) {
//             navigate('/user'); // Redirige al formulario de usuario (login/signup)
//         }
//     };
...
//                     <div className="flex items-center space-x-3">
//                         <img
//                             src={authStore.user.profilePicture || "/default-profile.jpg"} // Mostrar la foto del usuario (o una predeterminada)
//                             alt="User Profile"
//                             className="w-10 h-10 rounded-full"
//                         />
//                         <span className="text-white">{authStore.user.name}</span>
