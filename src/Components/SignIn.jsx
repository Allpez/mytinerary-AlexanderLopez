...
// // { toggleForm, handleGoogleLogin, handleSubmit }

// const Signin = ({toggleForm, handleGoogleLogin}) => {
...
//       className="form w-96 max-w-sm p-6 space-y-5 flex flex-col items-center rounded-lg shadow-md">
