...
const User = () => {
  ...
  const toggleForm = () => {
    setIsSignIn((prevState) => !prevState); // Alterna entre formularios
  };

  return (
    <div className="form w-96 max-w-sm p-6 my-6 space-y-5 flex flex-col items-center justify-center h-auto rounded-lg shadow-md">
      {isSignIn ? (
...
//   const toggleForm = () => {
//     setIsSignIn((prevState) => !prevState); // Alterna entre Sign In y Create Account
//   };
